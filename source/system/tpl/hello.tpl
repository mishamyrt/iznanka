...
<style type="text/css" media="screen">body,html{font-family:-apple-system,Arial,Helvetica,sans-serif;font-size:17px;line-height:28px;padding:0;margin:0}h1{font-size:37px;line-height:37px;margin-bottom:16px}p{margin:0 0 10px}span{color: #10797c;padding: 0 0 0 3px;}img{width:60px;display:block;margin:22px auto 0}section{max-width:500px;margin:0 auto}</style>
